...
const projectsData = [
   ...
   },
   {
      ...
      category: "Web Development",
      shortDesc: "A no-auth Django REST API powering an AI therapist mood journal — sub-second empathetic responses via GROQ's LLaMA 3.1, with persistent history and weekly wellness letters.",
      fullDesc: "MindEase is a mental wellness REST API built with Django REST Framework. Users submit mood entries (emoji + thoughts) and instantly receive warm, personalized AI responses from Luna — powered by GROQ's llama-3.1-8b-instant model on LPU infrastructure. No authentication required. The API persists all journal entries with ISO 8601 timestamps, generates weekly wellness summary letters with mood statistics, and ships with interactive Swagger and ReDoc documentation. Deployed live on Railway with auto-deploy from GitHub.",
      ...
      features: [
         ...
         "Persistent mood journal history with ISO 8601 timestamps",
